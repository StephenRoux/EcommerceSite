...
<div class="small-container">
  ...
  <div class="small-container">
        <h2 style="margin:40px 20px;">Admin Login</h2>
 		<form action="#" method="post" onSubmit="sign_in(event, 'admin')"  style="max-width:400px;">
...
<!------ footer ------->
<script>
<?php if(isset($_GET['reff'])) echo 'var glob_reff = "'.$_GET['reff'].'"'; else  echo 'var glob_reff = "./"'; ?>
